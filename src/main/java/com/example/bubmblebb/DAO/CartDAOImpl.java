...
public class CartDAOImpl implements CartDAO{
    ...
    public boolean addCart(Cart c) {
        ...
        try{
            ...
            String sql = "insert into cart(pid,uid,product_Name,product_Brand,price,total_price) values(?,?,?,?,?,?)";
            PreparedStatement ps = conn.prepareStatement(sql);
            ps.setInt(1, c.getPid());
            ps.setInt(2, c.getUserId());
            ps.setString(3, c.getProductName());
            ps.setString(4, c.getProductBrand());
    ...
    public List<Cart> getProductByUser(int userId) {
        ...
        try{
            ...
            while (rs.next())
            {
                ...
                c.setProductBrand(rs.getString(5));
